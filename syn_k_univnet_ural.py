...
def parse_args(parser):
    ...
    parser.add_argument('--fastpitch', type=str, default='output_uralic/FastPitch_checkpoint_170.pt',
                        help='Full path to the generator checkpoint file (skip to use ground truth mels)') #########    
    ...
    text_processing.add_argument('--symbol-set', type=str, default='uralic', #################
                                 help='Define symbol set for input text')

    cond = parser.add_argument_group('conditioning on additional attributes')

    cond.add_argument('--n-speakers', type=int, default=25,
                      help='Number of speakers in the model.')
    cond.add_argument('--n-languages', type=int, default=5,
